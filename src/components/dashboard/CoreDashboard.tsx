...
import { Radio, Trophy, Target, Zap, Users, Rocket, AlertTriangle, X } from 'lucide-react';
...
export function CoreDashboard() {
  ...
  const { stats, loading: statsLoading, refreshStats, showLevelUpModal, setShowLevelUpModal } = usePlayerStats(user);
          ...
          <div className="flex items-start gap-3">
            ...
            <div className="flex-1">
              <div className="flex justify-between items-start">
                <h3 className="text-white font-semibold">Fuel Points Needed!</h3>
                <button 
              ...
              <p className="text-sm text-gray-300 mt-1">
                It's been {data?.days_since_fp} days since you earned Fuel Points. Complete a daily boost to maintain your progress!
              </p>
              <button
                onClick={() => {
                  setActiveTab('boosts');
          ...
          <div className="space-y-4">
            ...
            <Card className="p-4 mb-20">
              <div className="flex items-center gap-2 mb-6">
                ...
                <div>
                  <h3 className="text-lg font-medium text-white">Your AI Health Agent</h3>
                  <p className="text-xs text-gray-400 mt-1">Cosmo can help you learn about the game, understand your health metrics, recommend guidance to support your personal health mission, and more.</p>
                </div>
              </div>
              <CosmoChat 
