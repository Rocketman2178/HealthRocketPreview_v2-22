...
export function BurnStreakChallenge({ onContinue }: BurnStreakChallengeProps) {
  return (
    <div className="bg-gray-800 rounded-lg p-6 shadow-xl">
      ...
      <p className="text-gray-300 text-center mb-6">
        Secure your 2,500 shares and a chance to win up to 100,000 more by completing this challenge
      </p>
      ...
      <div className="space-y-4">
        <div className="bg-gray-700/50 rounded-lg p-4">
          ...
          <p className="text-sm text-gray-400">
            Complete a 45-Day Burn Streak, earning at least 1 Fuel Point each day for 45 consecutive days. Must be completed during the preview period of June 1 to July 30 2025.
          </p>
        </div>
        ...
        <button 
          onClick={onContinue}
          className="w-full px-4 py-2 bg-orange-500 text-white rounded-lg font-medium hover:bg-orange-600 flex items-center justify-center gap-2 group mt-4"
        >
          <span>Continue</span>
